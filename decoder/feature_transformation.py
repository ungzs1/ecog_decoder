...
def get_correlation(px, py):
    ...
    Returns r-value and p-value for Low Frequency Band and High Freqvency Band (r-value from signed r-squared
    cross-correlation and p-value from unpaired t-test)
    """
